//
//  StatisticsAcceptViewController.m
//  XW_Customs_Ios
//
//  Created by 武新义 on 2022/6/2.
//

#import "StatisticsAcceptViewController.h"
#import "xw_OfficeViewModel.h"
#import "xw_StatisticsAcceptCell.h"
#import "xw_StatisticsAcceptModel.h"
@interface StatisticsAcceptViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation StatisticsAcceptViewController
...
-(void)getData{
    ...
    [[self.viewModel.acceptStatiCommand execute:params] subscribeNext:^(id  _Nullable x) {
        [self.tableview.mj_header endRefreshing];
        
        NSArray* array = [xw_StatisticsAcceptModel mj_objectArrayWithKeyValuesArray:x[@"data"]];
        if (array.count < 10) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    xw_StatisticsAcceptCell *cell = [tableView dequeueReusableCellWithIdentifier:@"xw_StatisticsAcceptCell"];
...
- (UITableView *)tableview {
    if (!_tableview) {
        ...
        [_tableview registerClass:[xw_StatisticsAcceptCell class] forCellReuseIdentifier:@"xw_StatisticsAcceptCell"];
    }
    return _tableview;
}
