...
@interface CertQrViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation CertQrViewController
...
-(void)getData{
    [[self.viewModel.getQrCodeCommand execute:self.model.id] subscribeNext:^(id  _Nullable x) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    xw_CertQrCell *cell = [tableView dequeueReusableCellWithIdentifier:@"xw_CertQrCell"];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return [tableView fd_heightForCellWithIdentifier:NSStringFromClass([xw_CertQrCell class]) cacheByIndexPath:indexPath configuration:^(id cell) {
        // configurations
    }];
}
...
- (UITableView *)tableview {
    if (!_tableview) {
        ...
        [_tableview registerClass:[xw_CertQrCell class] forCellReuseIdentifier:@"xw_CertQrCell"];
    }
    return _tableview;
}
