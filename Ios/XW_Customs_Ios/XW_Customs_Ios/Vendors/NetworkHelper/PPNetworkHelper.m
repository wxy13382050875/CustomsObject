...
+ (NSURLSessionTask *)GET:(NSString *)URL
    ...
    return [self GET:URL parameters:params responseCache:nil success:success failure:failure];
}
...
+ (NSURLSessionTask *)POST:(NSString *)URL
    ...
    return [self POST:URL parameters:params responseCache:nil success:success failure:failure];
}
...
+ (void)initialize {
    ...
    [_sessionManager.requestSerializer setValue:@"Ios" forHTTPHeaderField:@"type"];
