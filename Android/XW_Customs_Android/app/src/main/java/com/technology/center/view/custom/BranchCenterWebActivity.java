...
public class BranchCenterWebActivity extends BaseActionBarActivity {
    ...
    protected int getLayoutId() {
        return R.layout.activity_branch_center_web_view;
    }
...
//        WaitDialog.show(BranchCenterWebActivity.this, "正在加载...");
...
//        WaitDialog.show(BranchCenterWebActivity.this, "请稍候...");
        userRepository.getOrgDetailById(params).observe(BranchCenterWebActivity.this, new Observer<BaseDto<OrgDetailModel>>() {
            @Override
